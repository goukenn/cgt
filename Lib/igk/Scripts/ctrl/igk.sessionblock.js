...
init:function(){
	...
	var m_nodeChild  = document.createElement("div");
	var m_visible =false;
	var m_oldh = 0;
	...
	function show_info(evt)	{
		...
		// console.debug("append child : "+	$igk(d).getComputedStyle("zIndex"));
...
var q = $igk(target);
q.addClass("igk-session-button").setCss(
		{
			"width":"24px",
			"height":"24px",
	...
	// console.debug("init ");
	//console.debug("init  session block");
	//m_block = q;
}
});
